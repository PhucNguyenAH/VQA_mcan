...
python3 run.py --RUN='train' --GPU='0' --VERSION='small_model'
python3 run.py --RUN='train' --GPU='0' --VERSION='small_model' --RESUME=True --CKPT_PATH='./ckpts/ckpt_small_model/epoch9.pkl' --CKPT_E=9
python3 run.py --RUN='train' --GPU='0' --VERSION='large_model' --MODEL='large'
python3 run.py --RUN='train' --GPU='0' --RESUME=True --MODEL='large' --CKPT_PATH='./ckpts/ckpt_large_model/epoch8.pkl' --VERSION='large_model' --CKPT_E=8 --ACCU=4
...
python3 run.py --RUN='val' --CKPT_V="small_model" --CKPT_E=13 --GPU='0'
```
...
python3 run.py --RUN='val' --GPU='0' --CKPT_PATH="./ckpts/ckpt_small_model/epoch13.pkl"
python3 run.py --RUN='val' --GPU='0' --MODEL='large' --CKPT_PATH="./ckpts/ckpt_large_model/epoch13.pkl"
...
# Download model
## Download small model in ckpts/ckpt_small_model
https://drive.google.com/file/d/1iOrbjxZ4B9vSsHcvbZ5HUHQnOe4H2RE3/view?usp=sharing
## Download large model in ckpts/ckpt_large_model
https://drive.google.com/file/d/1FvflIX2T8psX-h6yOIwKS2pUNadQUhEi/view?usp=sharing